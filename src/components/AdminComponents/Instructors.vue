      ...
      <q-form
        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <q-card-section class="q-pb-none q-pt-sm">
              <q-input dense type="textarea" outlined v-model="editData.description.value" label="Description"
      ...
      <q-form
        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <q-card-section class="q-pb-none q-pt-sm">
              <q-input dense type="textarea" outlined v-model="newData.description.value" label="Description"
                :rules="[val => !!val || 'Description is missing']" />
            </q-card-section>
          </div>
        </div>
